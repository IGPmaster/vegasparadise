...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/devalue/index.js';
import destr from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/mikaelohlen/igp-nuxt/hippozino/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "siteUrl": "https://www.hippozino.com",
    "siteName": "Hippozino - Your Casino Anywhere",
    "siteDescription": "Enjoy seamless mobile gaming with Hippozino's mobile slots. Play popular titles like Thunderstruck 2 on the go and never miss a chance to win big!",
    "language": "en"
  }
};
const envOptions = {
...
const serverAssets = [{"baseName":"server","dir":"/Users/mikaelohlen/igp-nuxt/hippozino/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mikaelohlen/igp-nuxt/hippozino","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mikaelohlen/igp-nuxt/hippozino/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mikaelohlen/igp-nuxt/hippozino/dist","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mikaelohlen/igp-nuxt/hippozino/dist/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mikaelohlen/igp-nuxt/hippozino/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _kGw6qoex74 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/mikaelohlen/igp-nuxt/hippozino";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _qfrkDYk5Xn = (nitroApp) => {
...
const _lazy_RVfNOZ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_RVfNOZ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_RVfNOZ, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"hid":"description","name":"description","content":"Enjoy seamless mobile gaming with Hippozino's mobile slots."}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Hippozino - Your Casino Anywhere","titleTemplate":"","charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
...
const getClientManifest = () => import('file:///Users/mikaelohlen/igp-nuxt/hippozino/dist/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/mikaelohlen/igp-nuxt/hippozino/dist/dist/server/server.mjs').then((r) => r.default || r);
