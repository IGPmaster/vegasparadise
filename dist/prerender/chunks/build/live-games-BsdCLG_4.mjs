import { f as fetchGames, b as fetchPromotions, l as loadTranslations, d as loadLang, m as msgTranslate, p as promotionsPosts, r as regLink, q as liveGames } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(liveGames), (game) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/live-games.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=live-games-BsdCLG_4.mjs.map
