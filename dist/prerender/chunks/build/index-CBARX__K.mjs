import { useSSRContext, ref, unref, mergeProps, withCtx, createVNode, toDisplayString } from 'file:///Users/irek/sites/hippozino/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrRenderStyle, ssrRenderAttrs, ssrInterpolate, ssrRenderClass } from 'file:///Users/irek/sites/hippozino/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc, o as fetchApiPromotions, p as promotionsPosts, k as pp_promotions, r as regLink, m as msgTranslate, n as newGames, i as popularGames, s as slotGames, c as casinoGames, j as jackpotGames } from './server.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-qlLozGtb.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(promotionsPosts), (promo) => {
        ...
        _push(`</div><div class="container mx-auto text-center sig_terms lg:py-5 lg:w-3/4" data-v-d154f661><div class="px-5" data-v-d154f661>${(_a = promo.acf.sig_terms) != null ? _a : ""}</div></div><main class="container mx-auto text-center py-4" data-v-d154f661><h1 class="site_heading text-lg md:text-2xl lg:text-4xl font-bold" data-v-d154f661>Hippozino - Your Casino Anywhere!</h1></main><div class="container mx-auto" data-v-d154f661><div class="flex justify-center lg:pb-5 py-3" data-v-d154f661><img class="lg:w-2/5 w-7/8 place-items-center"${ssrRenderAttr("src", promo.acf.trust_icons)} alt="100% Licensed and fast payouts" data-v-d154f661></div></div></div>`);
      });
      _push(`<!--]--></div><!--]-->`);
    };
  }
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(promotionsPosts), (rest) => {
        var _a;
        _push(`<div class="container py-10 mx-auto info_content" data-v-73ac6080><div class="leading-relaxed" data-v-73ac6080>${(_a = rest.acf.promo_over) != null ? _a : ""}</div></div>`);
      });
      ...
      ssrRenderList(unref(promotionsPosts), (rest) => {
        var _a;
        _push(`<div class="container mx-auto py-2 info_content hide_this" data-v-73ac6080><div data-v-73ac6080>${(_a = rest.acf.promo_under) != null ? _a : ""}</div></div>`);
      });
      _push(`<!--]--></div></div>`);
      ...
      ssrRenderList(unref(promotionsPosts), (promotion) => {
        var _a;
        _push(`<div data-v-73ac6080><div data-v-73ac6080>${(_a = promotion.content.rendered) != null ? _a : ""}</div></div>`);
      });
      _push(`<!--]--></div></div></div><!--]-->`);
    };
  }
...
//# sourceMappingURL=index-CBARX__K.mjs.map
