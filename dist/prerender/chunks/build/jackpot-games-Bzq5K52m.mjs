import { f as fetchGames, b as fetchPromotions, l as loadTranslations, d as loadLang, m as msgTranslate, p as promotionsPosts, r as regLink, j as jackpotGames } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList("promotionsPosts" in _ctx ? _ctx.promotionsPosts : unref(promotionsPosts), (promo) => {
        _push(`<div><div class="info_content py-5 px-4">${ssrInterpolate(promo.acf.jackpot_games_info)}</div></div>`);
      });
      ...
      ssrRenderList(unref(jackpotGames), (game) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/jackpot-games.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=jackpot-games-Bzq5K52m.mjs.map
