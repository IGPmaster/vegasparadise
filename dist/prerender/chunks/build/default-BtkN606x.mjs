...
import { m as msgTranslate, r as regLink, A as loginLink, y as footerIcons, z as footerText, _ as _export_sfc, w as fetchFooterIcons, e as lang, x as fetchFooterText } from './server.mjs';
import { ref, mergeProps, withCtx, unref, createTextVNode, toDisplayString, createVNode, useSSRContext } from 'file:///Users/irek/sites/hippozino/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderList } from 'file:///Users/irek/sites/hippozino/node_modules/vue/server-renderer/index.mjs';
...
const _imports_1 = "" + buildAssetsURL("hz-logo-h3.DGvARksu.svg");
const _sfc_main$2 = {
  __name: "Footer",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList("footerIcons" in _ctx ? _ctx.footerIcons : unref(footerIcons), (icon) => {
        var _a;
        _push(`<div data-v-3d45fc7d><div data-v-3d45fc7d>${(_a = icon.Html) != null ? _a : ""}</div></div>`);
      });
      _push(`<!--]--><!--[-->`);
      ssrRenderList("footerText" in _ctx ? _ctx.footerText : unref(footerText), (text) => {
        var _a;
        _push(`<div class="py-5" data-v-3d45fc7d><p data-v-3d45fc7d>${(_a = text.Html) != null ? _a : ""}</p></div>`);
      });
...
//# sourceMappingURL=default-BtkN606x.mjs.map
