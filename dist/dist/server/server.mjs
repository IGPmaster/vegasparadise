import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineComponent, computed, provide, Suspense, nextTick, mergeProps, Transition, watch, Fragment, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "all-games",
    path: "/all-games",
    component: () => import("./_nuxt/all-games-DFIRb_ZS.js")
  },
  {
    name: "casino-games",
    path: "/casino-games",
    component: () => import("./_nuxt/casino-games-BDMhikJf.js")
  },
  {
    name: "compliance-slug",
    path: "/compliance/:slug()",
    component: () => import("./_nuxt/_slug_-Cf7nTSsk.js")
  },
  {
    name: "compliance",
    path: "/compliance",
    component: () => import("./_nuxt/index-DDthR8Y7.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CBARX__K.js")
  },
  {
    name: "jackpot-games",
    path: "/jackpot-games",
    component: () => import("./_nuxt/jackpot-games-Bzq5K52m.js")
  },
  {
    name: "live-games",
    path: "/live-games",
    component: () => import("./_nuxt/live-games-BsdCLG_4.js")
  },
  {
    name: "lp-halloween",
    path: "/lp/halloween",
    component: () => import("./_nuxt/index-493kvOn-.js")
  },
  {
    name: "lp-test",
    path: "/lp/test",
    component: () => import("./_nuxt/index-DRNmmb5w.js")
  },
  {
    name: "popular-games",
    path: "/popular-games",
    component: () => import("./_nuxt/popular-games-BtF7S1lw.js")
  },
  {
    name: "promotions",
    path: "/promotions",
    component: () => import("./_nuxt/index-BcsR8smk.js")
  },
  {
    name: "scratchcards",
    path: "/scratchcards",
    component: () => import("./_nuxt/scratchcards-1fvpVz_c.js")
  },
  {
    name: "slot-games",
    path: "/slot-games",
    component: () => import("./_nuxt/slot-games-DOTZdh4K.js")
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-BtkN606x.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Bf4gHoTx.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DNhy5xWk.js"));
...
export {
  ...
  msgTranslate as m,
  newGames as n,
  fetchApiPromotions as o,
  promotionsPosts as p,
  liveGames as q,
  regLink as r,
  slotGames as s,
  scratchGames as t,
  ...
  fetchFooterIcons as w,
  fetchFooterText as x,
  footerIcons as y,
  footerText as z
};
