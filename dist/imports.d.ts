...
export { lang, tracker, jurisdictionCode, footerIcons, footerText, globalContent, WHITELABEL_ID, PP_API_URL, KV_GAMES, FILTERED_BY_NAME_KV, checkCountry, loadLang, loadTranslations, fetchPromotions, fetchFilterByName, handleParameter, fetchSupportedCountries, fetchFooterIcons, fetchFooterText, //fetchPromotions, fetchApiPromotions, games, newGames, popularGames, jackpotGames, casinoGames, slotGames, scratchGames, liveGames, blackjackGames, rouletteGames, regLink, loginLink, playLink, msgTranslate, pp_promotions, promotionsPosts, countryCode, countryName, countries, country, countriesData, countryNotSupported, fetchGames, getCookie, setCookie } from '../composables/globalData';
