...
useHead({
	title: 'Jackpot Games - Vegas Paradise',
	meta: [
		{ hid: 'description', name: 'description', content: 'Explore the best jackpot games available at Vegas Paradise!' },
		{ name: 'keywords', content: 'jackpot, games, casino, Vegas Paradise' }
	]
});
</script>
