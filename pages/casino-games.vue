...
useHead({
	title: 'Casino Games - Vegas Paradise',
	meta: [
		{ hid: 'description', name: 'description', content: 'Explore the best casino games available at Vegas Paradise!' },
		{ name: 'keywords', content: 'casino, games, casino, Vegas Paradise' }
	]
});
</script>
