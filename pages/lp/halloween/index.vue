<template>
    ...
    <p class="text-lg text-orange-100 block lg:hidden">Enjoy Amazing Halloween Promos at Vegas Paradise!</p>
...
useHead({
    title: 'Halloween Promotions - Vegas Paradise',
    meta: [
        { hid: 'description', name: 'description', content: 'Enjoy spooktacular Halloween promotions and tournaments at Vegas Paradise!' },
        { name: 'keywords', content: 'halloween, promotions, tournament, spooky games, casino, Vegas Paradise' }
    ]
});
</script>
